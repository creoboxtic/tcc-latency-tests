...
| Latência mínima (ms) | 4407 | 1383 |
| Latência máxima (ms) | 7492 | 5880 |
| Latência média (ms) | 6150.00 | 4821.28 |
| Desvio padrão (ms) | 818.54 | 651.64 |
| **p50 (mediana)** | **5824 ms** | **4895 ms** |
| p90 | 7220 ms | 5633 ms |
| p95 | 7314 ms | 5699 ms |
| p99 | 7492 ms | 5880 ms |
| TPS sequencial observado | 0.16 | 0.21 |
...
|---|---:|---:|---|
| XRP Ledger | 0.16 | 1.500 (commodity hw) | xrpl.org/blog/2017 |
