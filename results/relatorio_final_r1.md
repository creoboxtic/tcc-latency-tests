...
| Latência mínima (ms) | 4424 | 3527 |
| Latência máxima (ms) | 7226 | 5340 |
| Latência média (ms) | 5668.70 | 4863.06 |
| Desvio padrão (ms) | 640.55 | 538.78 |
| **p50 (mediana)** | **5839 ms** | **5101 ms** |
| p90 | 6137 ms | 5333 ms |
| p95 | 6156 ms | 5336 ms |
| p99 | 7226 ms | 5340 ms |
| TPS sequencial observado | 0.18 | 0.21 |

*Fonte: Elaborado pelos autores a partir de testes empíricos realizados em 2026-05-15.*
...
|---|---:|---:|---|
| XRP Ledger | 0.18 | 1.500 (commodity hw) | xrpl.org/blog/2017 |
